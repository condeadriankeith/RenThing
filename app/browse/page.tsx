...
export default function BrowsePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      {/* Hero Section */}
      <section className="bg-white dark:bg-gray-800 text-gray-900 dark:text-white py-12 sm:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto rounded-2xl shadow-2xl p-6 sm:p-8 md:p-10" style={{ backgroundColor: '#f0f9ff' }}>
            <div className="text-center">
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6">
                Rent Anything, Anywhere
              </h1>
              <p className="text-lg sm:text-xl mb-8 max-w-2xl mx-auto">
                Find the perfect items for your needs or list your own to earn extra income
              </p>
              ...
              <div className="flex flex-wrap justify-center gap-2 sm:gap-4">
                <Button 
                  variant="secondary" 
                  className="text-sm sm:text-base px-3 sm:px-4 py-2 bg-blue-100 hover:bg-blue-200 border-0"
                  onClick={() => {

...
export function Modal({ isOpen, onClose, children }: ModalProps) {
  ...
  React.useEffect(() => {
    ...
    // Wait for next tick to ensure browser extensions have finished modifying DOM
  ...
  // Completely prevent any rendering until we're sure extensions are done
  if (!mounted || !safeToRender || !isOpen) {
    return null;
  }
